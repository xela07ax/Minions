...
type ProcessorFunc func(gopherNumber int, element interface{}, out chan interface{}) // out - Интерфейс, чтобы сделать библиотеку более гибкой.
type Conveer struct {
	Name       string
	InputChan  chan interface{}
	OutputChan chan interface{}
	execFunc   ProcessorFunc
	process    *mutexRunner
...
func NewConveer(name string, execFunc ProcessorFunc) *Conveer {
	return &Conveer{
		Name:       name,
		execFunc:   execFunc,
